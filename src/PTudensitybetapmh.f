...
c=======================================================================                      
      subroutine ptdensitybetaupmh(ngrid,nrec,y,
     &                       ab,arand,brand,jfr,m0,s0,tau,
     &                       nlevel,ninter,
...
c        ac         :  real giving the value of the candidate
...
c        sec00       :  cpu time working variabe.
...
c+++++Working space - Distributions
      ...
      double precision invcdfnorm,invcdfbetas
